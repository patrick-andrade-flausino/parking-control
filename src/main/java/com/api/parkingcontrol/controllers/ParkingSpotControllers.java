...
public class ParkingSpotControllers {
    ...
    public ParkingSpotControllers(ParkingSpotService parkingspot) {
        this.parkingSpotService = parkingspot;
    }
    ...
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDTO parkingSpotDTO){
        ...
        if(parkingSpotService.existsByApartmentAndBlock(parkingSpotDTO.getApartment(), parkingSpotDTO.getBlock())){
            return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflict: Apartment and Block is already registrered! ");
        }
